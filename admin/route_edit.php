...
<?php
$where['id']=$_GET['id'];
$route = $mysqli->common_select('route','*', $where);
if(!$route['error']){
$route = $route['data'][0];
}
?>
 ...
 <div class="row">
                              ...
                              <form method="post" action="" class="form-horizontal form-label-left">
                                    <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="" name="" value="<?= $route->id ?>" required="required" class="form-control ">
                                          </div>
                                    </div>
                                    <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="route_type" name="route_type" value="<?= $route->route_type ?>" required="required" class="form-control">
                                          </div>
                                    </div>
  ...
  <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="to_airport" name="to_airport" value="<?= $route->to_airport ?>" required="required" class="form-control">
                                          </div>
                                    </div>
...
<div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="from_airport" name="from_airport" value="<?= $route->from_airport ?>" required="required" class="form-control">
                                          </div>
                                    </div>
...
<div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="trans_area" name="trans_area" value="<?= $route->trans_area ?>" required="required" class="form-control">
                                          </div>
                                    </div>
